...
rules: [/^(?:真偽(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:((((([1-9１-９])([0-9０-９])*)|(0x([0-9A-Fa-f０-９Ａ-Ｆａ-ｆ])+)|(0b([01０１])+)|(0o([0-7０-７])+)|[0０])([.．]([0-9０-９])+)?[eE][+-]?((([1-9１-９])([0-9０-９])*)|(0x([0-9A-Fa-f０-９Ａ-Ｆａ-ｆ])+)|(0b([01０１])+)|(0o([0-7０-７])+)|[0０]))|(((([1-9１-９])([0-9０-９])*)|(0x([0-9A-Fa-f０-９Ａ-Ｆａ-ｆ])+)|(0b([01０１])+)|(0o([0-7０-７])+)|[0０])[.．]([0-9０-９])+))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:((([1-9１-９])([0-9０-９])*)|(0x([0-9A-Fa-f０-９Ａ-Ｆａ-ｆ])+)|(0b([01０１])+)|(0o([0-7０-７])+)|[0０])(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:(真|[Tt][Rr][Uu][Ee])(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:(偽|[Ff][Aa][Ll][Ss][Ee])(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:(「[^」]*」|'(\\'|[^\'])*'|"(\\"|[^"])*")(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:(《[^》]*》)(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([\=＝][\=＝]))/,/^(?:([\=＝]))/,/^(?:([\+＋][\=＝]))/,/^(?:([\-ー−‐][\=＝]))/,/^(?:([\*＊×][\=＝]))/,/^(?:([/／][\=＝]))/,/^(?:(([/／][/／]|÷)[\=＝]))/,/^(?:([%％][\=＝]))/,/^(?:([&＆][\=＝]))/,/^(?:([\|｜][\=＝]))/,/^(?:([\^＾][\=＝]))/,/^(?:([<＜][<＜][\=＝]))/,/^(?:([>＞][>＞][\=＝]))/,/^(?:([+＋]))/,/^(?:([-ー−‐]))/,/^(?:([\*＊×][\*＊×]))/,/^(?:([\*＊×]))/,/^(?:([/／][/／]|÷))/,/^(?:([/／]))/,/^(?:([%％]))/,/^(?:\.)/,/^(?:[\(（])/,/^(?:[\)）])/,/^(?:[\[［])/,/^(?:[\]］])/,/^(?:[{｛])/,/^(?:[}｝])/,/^(?:(([>＞][=＝])|≧))/,/^(?:(([<＜][=＝])|≦))/,/^(?:([>＞][>＞]))/,/^(?:([<＜][<＜]))/,/^(?:([>＞]))/,/^(?:([<＜]))/,/^(?:(([!！][=＝])|([<＜][>＞])|≠))/,/^(?:([&＆]))/,/^(?:([\|｜]))/,/^(?:([\^＾]))/,/^(?:([~〜]))/,/^(?:([，,、]))/,/^(?:([:：]))/,/^(?:([Aa][Nn][Dd](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Oo][Rr](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Nn][Oo][Tt]\s[Ii][Nn](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Nn][Oo][Tt](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ii][Nn](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ii][Ff](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ee][Ll][Ii][Ff](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ee][Ll][Ss][Ee](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ww][Hh][Ii][Ll][Ee](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ff][Oo][Rr](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Pp][Rr][Ii][Nn][Tt](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Rr][Ee][Tt][Uu][Rr][Nn](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Pp][Aa][Ss][Ss](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Bb][Rr][Ee][Aa][Kk](?=[^a-zA-Z0-9_]))(?=Bounday))/,/^(?:([Dd][Ee][Ff](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ii][Nn][Tt](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ff][Ll][Oo][Aa][Tt](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ss][Tt][Rr](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Bb][Oo][Oo][Ll](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:■)/,/^(?:を(改行(無しで|なしで|せずに))で(表示|印刷|出力)する(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:を(表示|印刷|出力)する(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:(改行(無しで|なしで|せずに))(表示|印刷|出力)する(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:(表示|印刷|出力)する(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:入力する(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:もし(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:ならば(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:そうでなければ(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:そうでなくもし(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:(の間(繰り返す|繰返す|くりかえす|))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:((繰り返し|繰返し|くりかえし))を((抜ける|ぬける|出る|でる))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:手続きを((抜ける|ぬける|出る|でる))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:関数を((抜ける|ぬける|出る|でる))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:手続き(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:関数(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:を返す(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:の中に(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:について(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:に(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:を(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:個の(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:から(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:まで(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:ずつ(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:((増やしながら|増やしつつ)(繰り返す|繰返す|くりかえす|))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:((減らしながら|減らしつつ)(繰り返す|繰返す|くりかえす|))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:((繰り返す|繰返す|くりかえす))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:の要素(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:(範囲|区間)(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:整数(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:実数(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:文字列(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:と([，,、])(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:と(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:で(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:追加する(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:連結する(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:追加(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:連結(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:描画領域開く(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gOpenWindow(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:描画領域閉じる(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gCloseWindow(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:描画領域全消去(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gClearWindow(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:線色設定(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gSetLineColor(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:塗色設定(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gSetFillColor(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:文字色設定(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gSetTextColor(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:線太さ設定(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gSetLineWidth(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:文字サイズ設定(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gSetFontSize(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:文字描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gDrawText(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:線描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gDrawLine(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:点描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gDrawPoint(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:矩形描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gDrawBox(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:矩形塗描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gFillBox(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:円描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gDrawCircle(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:円塗描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gFillCircle(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:楕円描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gDrawOval(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:楕円塗描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gFillOval(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:弧描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gDrawArc(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:弧塗描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gFillArc(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:棒グラフ描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gBarplot(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:線グラフ描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gLinePlot(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:グラフ描画(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gDrawGraph(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:グラフ消去(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:gClearGraph(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:ミリ秒待つ(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:変数を確認する(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:改行する(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:何もしない(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:一時停止する(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:一時停止(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:(([_a-zA-Zａ-ｚＡ-Ｚ\u3040-\u30FF\u4E00-\u9FFF])([_a-zA-Z0-9ａ-ｚＡ-Ｚ０-９\u3040-\u30FF\u4E00-\u9FFF])*))/,/^(?:([#＃♯].*(\r|\n|\r\n)))/,/^(?:$)/,/^(?:((\r\n|\r|\n)+))/,/^(?:([ 　\t]))/],
