...
rules: [/^(?:([\=＝][\=＝]))/,/^(?:([\=＝]))/,/^(?:([\+＋][\=＝]))/,/^(?:([\-ー−‐][\=＝]))/,/^(?:([\*＊×][\=＝]))/,/^(?:([/／][\=＝]))/,/^(?:(([/／][/／]|÷)[\=＝]))/,/^(?:([%％][\=＝]))/,/^(?:([&＆][\=＝]))/,/^(?:([\|｜][\=＝]))/,/^(?:([\^＾][\=＝]))/,/^(?:([<＜][<＜][\=＝]))/,/^(?:([>＞][>＞][\=＝]))/,/^(?:([+＋]))/,/^(?:([-ー−‐]))/,/^(?:([\*＊×][\*＊×]))/,/^(?:([\*＊×]))/,/^(?:([/／][/／]|÷))/,/^(?:([/／]))/,/^(?:([%％]))/,/^(?:\.)/,/^(?:[\(（])/,/^(?:[\)）])/,/^(?:[\[［])/,/^(?:[\]］])/,/^(?:[{｛])/,/^(?:[}｝])/,/^(?:(([>＞][=＝])|≧))/,/^(?:(([<＜][=＝])|≦))/,/^(?:([>＞][>＞]))/,/^(?:([<＜][<＜]))/,/^(?:([>＞]))/,/^(?:([<＜]))/,/^(?:(([!！][=＝])|([<＜][>＞])|≠))/,/^(?:([&＆]))/,/^(?:([\|｜]))/,/^(?:([\^＾]))/,/^(?:([~〜]))/,/^(?:([，,、]))/,/^(?:([:：]))/,/^(?:([Aa][Nn][Dd](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Oo][Rr](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Nn][Oo][Tt]\s[Ii][Nn](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Nn][Oo][Tt](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ii][Nn](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ii][Ff](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ee][Ll][Ii][Ff](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ee][Ll][Ss][Ee](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ww][Hh][Ii][Ll][Ee](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ff][Oo][Rr](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Pp][Rr][Ii][Nn][Tt](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Rr][Ee][Tt][Uu][Rr][Nn](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Pp][Aa][Ss][Ss](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Bb][Rr][Ee][Aa][Kk](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Dd][Ee][Ff](?=[^a-zA-Z0-9_]))(?=([^_a-zA-Z0-9\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:([Ii][Nn][Tt](?=[^a-zA-Z0-9_])))/,/^(?:([Ff][Ll][Oo][Aa][Tt](?=[^a-zA-Z0-9_])))/,/^(?:([Ss][Tt][Rr](?=[^a-zA-Z0-9_])))/,/^(?:([Bb][Oo][Oo][Ll](?=[^a-zA-Z0-9_])))/,/^(?:■)/,/^(?:を(改行(無しで|なしで|せずに))で(表示|印刷|出力)する)/,/^(?:を(表示|印刷|出力)する)/,/^(?:(改行(無しで|なしで|せずに))(表示|印刷|出力)する)/,/^(?:(表示|印刷|出力)する)/,/^(?:入力する)/,/^(?:もし(?=([^_a-zA-Zａ-ｚＡ-Ｚ\u3040-\u30FF\u4E00-\u9FFF])))/,/^(?:ならば)/,/^(?:そうでなければ)/,/^(?:そうでなくもし)/,/^(?:(の間(繰り返す|繰返す|くりかえす|)))/,/^(?:((繰り返し|繰返し|くりかえし))を((抜ける|ぬける|出る|でる)))/,/^(?:手続きを((抜ける|ぬける|出る|でる)))/,/^(?:関数を((抜ける|ぬける|出る|でる)))/,/^(?:手続き)/,/^(?:関数)/,/^(?:を返す)/,/^(?:の中に)/,/^(?:について)/,/^(?:まで)/,/^(?:((増やしながら|増やしつつ)(繰り返す|繰返す|くりかえす|)))/,/^(?:((減らしながら|減らしつつ)(繰り返す|繰返す|くりかえす|)))/,/^(?:の要素)/,/^(?:に)/,/^(?:を)/,/^(?:個の)/,/^(?:と([，,、]))/,/^(?:と)/,/^(?:で)/,/^(?:から)/,/^(?:ずつ)/,/^(?:((繰り返す|繰返す|くりかえす)))/,/^(?:(範囲|区間))/,/^(?:整数)/,/^(?:実数)/,/^(?:文字列)/,/^(?:追加する)/,/^(?:連結する)/,/^(?:追加)/,/^(?:連結)/,/^(?:描画領域開く)/,/^(?:gOpenWindow\b)/,/^(?:描画領域閉じる)/,/^(?:gCloseWindow\b)/,/^(?:描画領域全消去)/,/^(?:gClearWindow\b)/,/^(?:線色設定)/,/^(?:gSetLineColor\b)/,/^(?:塗色設定)/,/^(?:gSetFillColor\b)/,/^(?:文字色設定)/,/^(?:gSetTextColor\b)/,/^(?:線太さ設定)/,/^(?:gSetLineWidth\b)/,/^(?:文字サイズ設定)/,/^(?:gSetFontSize\b)/,/^(?:文字描画)/,/^(?:gDrawText\b)/,/^(?:線描画)/,/^(?:gDrawLine\b)/,/^(?:点描画)/,/^(?:gDrawPoint\b)/,/^(?:矩形描画)/,/^(?:gDrawBox\b)/,/^(?:矩形塗描画)/,/^(?:gFillBox\b)/,/^(?:円描画)/,/^(?:gDrawCircle\b)/,/^(?:円塗描画)/,/^(?:gFillCircle\b)/,/^(?:楕円描画)/,/^(?:gDrawOval\b)/,/^(?:楕円塗描画)/,/^(?:gFillOval\b)/,/^(?:弧描画)/,/^(?:gDrawArc\b)/,/^(?:弧塗描画)/,/^(?:gFillArc\b)/,/^(?:棒グラフ描画)/,/^(?:gBarplot\b)/,/^(?:線グラフ描画)/,/^(?:gLinePlot\b)/,/^(?:グラフ描画)/,/^(?:gDrawGraph\b)/,/^(?:グラフ消去)/,/^(?:gClearGraph\b)/,/^(?:ミリ秒待つ)/,/^(?:変数を確認する)/,/^(?:改行する)/,/^(?:何もしない)/,/^(?:一時停止する)/,/^(?:一時停止)/,/^(?:真偽)/,/^(?:((((([1-9１-９])([0-9０-９])*)|(0x([0-9A-Fa-f０-９Ａ-Ｆａ-ｆ])+)|(0b([01０１])+)|(0o([0-7０-７])+)|[0０])([.．]([0-9０-９])+)?[eE][+-]?((([1-9１-９])([0-9０-９])*)|(0x([0-9A-Fa-f０-９Ａ-Ｆａ-ｆ])+)|(0b([01０１])+)|(0o([0-7０-７])+)|[0０]))|(((([1-9１-９])([0-9０-９])*)|(0x([0-9A-Fa-f０-９Ａ-Ｆａ-ｆ])+)|(0b([01０１])+)|(0o([0-7０-７])+)|[0０])[.．]([0-9０-９])+)))/,/^(?:((([1-9１-９])([0-9０-９])*)|(0x([0-9A-Fa-f０-９Ａ-Ｆａ-ｆ])+)|(0b([01０１])+)|(0o([0-7０-７])+)|[0０]))/,/^(?:(真|[Tt][Rr][Uu][Ee]))/,/^(?:(偽|[Ff][Aa][Ll][Ss][Ee]))/,/^(?:(「[^」]*」|'(\\'|[^\'])*'|"(\\"|[^"])*"))/,/^(?:(《[^》]*》))/,/^(?:((([_a-zA-Z])([_a-zA-Z0-9])*)|(([\u3040-\u309F\u30A0-\u30FF\u4E00-\u9FFF])([\u3040-\u309F\u30A0-\u30FF\u4E00-\u9FFF_a-zA-Z0-9])*)))/,/^(?:([#＃♯].*(\r|\n|\r\n)))/,/^(?:$)/,/^(?:((\r\n|\r|\n)+))/,/^(?:([ 　\t]))/],
